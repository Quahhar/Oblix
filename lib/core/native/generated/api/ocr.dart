...
// These functions are ignored because they are not marked as `pub`: `alignment_score`, `assign_bands`, `build_rows`, `centre_x`, `centre_x`, `centre_y`, `centre_y`, `classify`, `column_of`, `confidence_stats`, `count`, `detect_columns_in`, `digit_share`, `drop_specks`, `edge_positions`, `effective_confidence`, `empty_draft`, `estimate_skew`, `estimate_tilt_tangent`, `extract_title`, `filter_lines`, `height`, `indent_levels`, `input_centre_x`, `input_centre_y`, `label`, `looks_labelled`, `measure_page_geometry`, `median`, `place`, `reconstruct`, `render_options`, `row_bucket`, `running_key`, `sampled`, `strip_running_heads`, `symbol_share`, `tidy`, `tilt_boxes`, `tilt_direction`, `truncate_title`, `undo_tilt_inflation`, `width`, `width`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `Box2`, `PageGeometry`, `Placed`, `Reconstruction`, `RowCell`, `Row`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`

/// Rebuild note text from one page of recognized line boxes.
ScannedNoteDraft shapeScannedText({
  required List<OcrLineInput> lines,
  required OcrShapeOptions options,
}) => RustLib.instance.api.crateApiOcrShapeScannedText(
  lines: lines,
  options: options,
);
...
ScannedNoteDraft shapeScannedPages({
  required List<OcrPageInput> pages,
  required OcrShapeOptions options,
}) => RustLib.instance.api.crateApiOcrShapeScannedPages(
  pages: pages,
  options: options,
);
...
class CaptureQuality {
  ...
  const CaptureQuality({
    ...
    required this.lowConfidenceShare,
    required this.scoredLines,
  ...
  int get hashCode =>
      ...
      lowConfidenceShare.hashCode ^
      scoredLines.hashCode ^
      advice.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is CaptureQuality &&
          ...
          lowConfidenceShare == other.lowConfidenceShare &&
          scoredLines == other.scoredLines &&
          advice == other.advice;
}
...
class OcrShapeOptions {
  ...
  const OcrShapeOptions({
    required this.minConfidence,
    required this.preserveLineBreaks,
    required this.detectColumns,
    required this.detectStructure,
    required this.detectTables,
    required this.stripRunningHeads,
    required this.healAcrossPages,
    required this.repairMisreads,
    required this.preset,
  });

  static Future<OcrShapeOptions> default_() =>
      RustLib.instance.api.crateApiOcrOcrShapeOptionsDefault();

  @override
  int get hashCode =>
      minConfidence.hashCode ^
      preserveLineBreaks.hashCode ^
      detectColumns.hashCode ^
      detectStructure.hashCode ^
      detectTables.hashCode ^
      stripRunningHeads.hashCode ^
      healAcrossPages.hashCode ^
      repairMisreads.hashCode ^
      preset.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is OcrShapeOptions &&
          ...
          detectColumns == other.detectColumns &&
          detectStructure == other.detectStructure &&
          detectTables == other.detectTables &&
          stripRunningHeads == other.stripRunningHeads &&
          healAcrossPages == other.healAcrossPages &&
          repairMisreads == other.repairMisreads &&
          preset == other.preset;
}
...
class ScannedNoteDraft {
  ...
  final int repairedWords;

  /// The preset actually used, never `auto`.
  final String preset;
  final CaptureQuality quality;

  const ScannedNoteDraft({
    required this.title,
    required this.body,
    ...
    required this.correctedSkewDegrees,
    required this.pages,
    required this.tables,
    required this.headings,
    required this.strippedRunningHeads,
    required this.repairedWords,
    required this.preset,
  ...
  int get hashCode =>
      ...
      keptLines.hashCode ^
      droppedLines.hashCode ^
      columns.hashCode ^
      correctedSkewDegrees.hashCode ^
      pages.hashCode ^
      tables.hashCode ^
      headings.hashCode ^
      strippedRunningHeads.hashCode ^
      repairedWords.hashCode ^
      preset.hashCode ^
      quality.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is ScannedNoteDraft &&
          ...
          keptLines == other.keptLines &&
          droppedLines == other.droppedLines &&
          columns == other.columns &&
          correctedSkewDegrees == other.correctedSkewDegrees &&
          pages == other.pages &&
          tables == other.tables &&
          headings == other.headings &&
          strippedRunningHeads == other.strippedRunningHeads &&
          repairedWords == other.repairedWords &&
          preset == other.preset &&
