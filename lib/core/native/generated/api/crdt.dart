...
List<String> remoteWinningFields({required List<CrdtFieldInput> inputs}) =>
    RustLib.instance.api.crateApiCrdtRemoteWinningFields(inputs: inputs);
...
class CrdtClockInput {
  ...
  const CrdtClockInput({
    required this.timestampMicrosUtc,
  ...
  bool operator ==(Object other) =>
      ...
      other is CrdtClockInput &&
          ...
          timestampMicrosUtc == other.timestampMicrosUtc &&
...
class CrdtFieldInput {
  ...
  @override
  int get hashCode =>
      field.hashCode ^ local.hashCode ^ remote.hashCode ^ excluded.hashCode;
