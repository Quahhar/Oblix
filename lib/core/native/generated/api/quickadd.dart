...
/// its subject.
QuickAddParse parseQuickAdd({
  required String text,
  required QuickAddContext context,
}) => RustLib.instance.api.crateApiQuickaddParseQuickAdd(
  text: text,
  context: context,
);
...
class QuickAddContext {
  ...
  bool operator ==(Object other) =>
      ...
      other is QuickAddContext &&
          ...
          today == other.today &&
          now == other.now &&
          todayWeekday == other.todayWeekday &&
          weekStartMonday == other.weekStartMonday &&
          monthFirst == other.monthFirst;
}
