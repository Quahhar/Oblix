...
String serializeRecurrence({required RecurrenceRule rule}) =>
    RustLib.instance.api.crateApiTasksSerializeRecurrence(rule: rule);
...
RecurrenceRule? parseRecurrence({required String text}) =>
    RustLib.instance.api.crateApiTasksParseRecurrence(text: text);
...
String describeRecurrence({required RecurrenceRule rule}) =>
    RustLib.instance.api.crateApiTasksDescribeRecurrence(rule: rule);
...
}) => RustLib.instance.api.crateApiTasksNextOccurrence(
  rule: rule,
  from: from,
  notBefore: notBefore,
);
...
RecurrenceAdvance advanceOnCompletion({
  String? recurrence,
  CivilDate? due,
  required bool dueHasTime,
  required CivilDate completedOn,
}) => RustLib.instance.api.crateApiTasksAdvanceOnCompletion(
...
/// genuinely due.
TaskViewPlan planTaskView({
  required List<TaskViewInput> tasks,
  required TaskViewContext context,
}) => RustLib.instance.api.crateApiTasksPlanTaskView(
  tasks: tasks,
  context: context,
);
...
List<CalendarDay> monthDensity({
  required List<TaskViewInput> tasks,
  required int year,
  required int month,
  required CivilDate today,
}) => RustLib.instance.api.crateApiTasksMonthDensity(
  tasks: tasks,
  year: year,
  month: month,
  today: today,
...
ReminderInstant? reminderTime({
  required CivilDate due,
  CivilTime? dueTime,
  required int leadMinutes,
  required int allDayHour,
  required int allDayMinute,
}) => RustLib.instance.api.crateApiTasksReminderTime(
  due: due,
  dueTime: dueTime,
...
List<SortAssignment> planReorder({
  required List<String> orderedIds,
  required List<SortAssignment> current,
}) => RustLib.instance.api.crateApiTasksPlanReorder(
...
class CalendarDay {
  ...
  bool operator ==(Object other) =>
      ...
      other is CalendarDay &&
          ...
          hasOverdue == other.hasOverdue &&
          hasUrgent == other.hasUrgent &&
...
class RecurrenceRule {
  ...
  @override
  int get hashCode =>
      freq.hashCode ^ interval.hashCode ^ byWeekday.hashCode ^ mode.hashCode;
...
class TaskRow {
  ...
  bool operator ==(Object other) =>
      ...
      other is TaskRow &&
          ...
          id == other.id &&
          depth == other.depth &&
          childTotal == other.childTotal &&
          childDone == other.childDone &&
...
enum TaskSectionKind { overdue, focus, anytime, completed }
